...
int main() {
    ...
    for (uint16_t test_number = 0; test_number < NUMBER_OF_TESTS; test_number++) {
        ...
        put_str("Test "); put_uint16(test_number + 1); 
        if (error == true) {
            put_str(" failed\r\n");
    ...
    put_str("Results\r\n");
    put_str("-------\r\n");
    put_str("FAIL: "); put_uint16(number_of_failed_tests); put_str(", PASS: "); put_uint16(NUMBER_OF_TESTS - number_of_failed_tests); put_str("\r\n");
